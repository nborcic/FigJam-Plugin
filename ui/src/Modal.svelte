...
<div class="fixed inset-0 bg-gray-800/50 flex items-center justify-center z-50">
  <div class="bg-white p-4 rounded shadow w-96">
    ...
    <input type="datetime-local" class="w-full border p-1 mb-3" bind:value={start} />

    <label class="block text-sm font-medium mb-1">End</label>
    <input type="datetime-local" class="w-full border p-1 mb-3" bind:value={end} />

    <div class="flex justify-end gap-2">
      <button class="bg-gray-300 px-3 py-1 rounded" on:click={onCancel}>Cancel</button>
